...
export default function main() {
    ...
    camera.position.set(256, 32, 256);
    ...
    async function generate_terrain() {
        const cellSize = new THREE.Vector3(64, 16, 64);
        ...
        const texture = loader.load('../data/minecraft-texture.png', render);
